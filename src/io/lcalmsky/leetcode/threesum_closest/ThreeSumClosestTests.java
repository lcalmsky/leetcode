...
public class ThreeSumClosestTests {
    ...
    public static void main(String[] args) {
        ThreeSumClosestTests threeSumClosestTests = new ThreeSumClosestTests();
        System.out.println(threeSumClosestTests.threeSumClosest(new int[]{-1, 2, 1, -4}, 1));
        System.out.println(threeSumClosestTests.threeSumClosest(new int[]{0, 0, 0}, 1));
    }
